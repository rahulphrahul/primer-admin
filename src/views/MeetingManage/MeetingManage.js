...
export default function MeetingManage() {
  ...
  return (
    ...
    Manage Meetings
        ...
        <GridContainer>
        <GridItem xs={12} sm={12} md={5} style={{marginBottom:"20px"}}>
...
<center>
          ...
          <table style={{marginTop:"10px",border:"1px solid #848383",width:"35%"}}><tr>
            <td style={{backgroundColor:"rgb(3 99 3)",color:"#fff",padding:"0px 3px"}}>Sheduled
            </td><td style={{backgroundColor:"rgb(255 149 64)",color:"#fff",width:"35%",padding:"0px 3px"}}><center>Edited</center>
    </td><td style={{backgroundColor:"#fff",color:"#000",width:"30%",padding:"0px 3px"}}><center>Free</center>
    </td></tr></table>
    </center>
        </Paper>
...
<form className={classes.root} noValidate autoComplete="off">
  <table style={{padding:"20px"}}>
    <tr>
        <td colSpan={2}>
          <center><Typography style={{fontWeight:"bold",fontSize:"20px",color:"#656765"}}>Reschedule Meeting</Typography></center>
          </td>
      </tr>
    <tr>
    <td style={{width:"25%"}}><Typography  style={{paddingTop:"20px"}} className={classes.griditems}>
                Branch
              </Typography></td>
