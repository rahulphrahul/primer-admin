  ...
  if (state.redirect) {
    ...
    return (
      <div style={{margin:"20px"}}>
            <div style={{padding:"10px",Width:"100%",boxShadow:"rgb(0 0 0 / 14%) 0px 4px 20px 0px, rgb(70 70 70 / 40%) 0px 7px 10px -5px",borderRadius:"5px"}}>
            <center>
...
<table>
  <center>
  <tr>
    <td colspan="6"style={{color:"#fff",textAlign: "center",backgroundColor:"#386a75"}}>Filter By TRIAL LESSONS STATUS</td>
  </tr>
  <tr>
