...
<Card >
<center>
        <CardHeader style={{padding:"12px",marginTop:"-20px", width:"90%" ,boxShadow:"rgb(0 0 0 / 14%) 0px 4px 20px 0px, rgb(70 70 70 / 40%) 0px 7px 10px -5px",borderRadius:"5px"}}>
      ...
      >
        ...
        <table >
          ...
          <tr><td colspan="2" style={{textAlign:"center"}}>
            <Button style={{backgroundColor:"#021c49",color:"#fff",minWidth:"100px",marginTop:"20px"}} onClick={saveForm}>ADD Program</Button>
          </td></tr>
          </table>
        </center>
        </div>
