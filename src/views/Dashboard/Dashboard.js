                ...
                collapses={[
                  {
                    ...
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                      <table style={{minHeight:"150px"}}>
                        <tr>
                          <td rowSpan={2} style={{width:"30%"}}><center> <img style={{width:"100%",height:"auto"}} src={'https://github.com/learn-alone/erxa_images/blob/master/institution.jpg'}/></center></td>
                    ...
                    <table style={{minHeight:"150px"}}>
                        <tr>
                          <td rowSpan={2} style={{width:"30%"}}><center>  <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/programs.jpg")} />   </center></td>
                    ...
                    <table style={{minHeight:"150px"}}>
                        <tr>
                          <td rowSpan={2} style={{width:"30%"}}><center> <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/ug.png")} />    </center></td>
                    ...
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                      <table style={{minHeight:"150px"}}>
                        <tr>
                          <td rowSpan={2} style={{width:"30%"}}><center>  <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/master.png")} />   </center></td>
                  ...
                  },
                  {
                    ...
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/us.jpg")} /></div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                    <table style={{minHeight:"150px"}}>
                        <tr>
                          <td rowSpan={2} style={{width:"30%"}}><center>  <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/institution.jpg")} />   </center></td>
                          <td><center><span style={{fontSize:"24px",fontWeight:"bold",color:"#7dbf7d"}}> 1321</span></center></td></tr>
                        <tr><td style={{fontSize:"18px",fontWeight:"bold",color: "#675d5d"}}><center> Institutions</center></td></tr>
                        <tr><td colSpan={2}><center><span style={{color:"rgb(103, 93, 93)",fontSize: "15px",fontWeight: "bold"}}>146</span> New Institutions this Month</center></td></tr>
                      </table>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/canada.png")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                      <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/australia.png")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/uk.png")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/germany.png")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/newzealand.jpg")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
                  ...
                  },
                  {
                    ...
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <div style={{width:"100%",height:"100%",alignItems:"center",justifyContent:"center",display:"flex"}}>
                    <img style={{width:"100%",height:"auto"}} src={require("../../assets/img/flag/poland.png")} />
                    </div>
                    </GridItem>
                    <GridItem xs={6} sm={4} md={2} style={{marginBottom:"15px"}}>
                    <Paper style={{borderRadius:"25px",padding:"5px",width:"100%",border:"2px solid #7dbf7d"}}>
