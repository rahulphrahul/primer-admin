...
import "pages/WhatToStudy/ToStudyitemTable.css";
  ...
  return (
    <div>
      <div>
        ...
        <CardHeader style={{padding:"12px"}} color="warning" >
            <center>
              ...
              <TableRow>
                {columns.map((column) => (
                  <TableCell
                    key={column.id}
                    align={column.align}
                    style={{ minWidth: column.minWidth ,padding:"8px",color:"#fff",backgroundColor:"#ff9800"}}
                  >
                    {column.label}
                  </TableCell>
                ))}
      ...
      >
        ...
        <table >
          ...
          <tr><td colspan="2" style={{textAlign:"center"}}>
            <Button style={{color:"#fff",backgroundColor:"#ff9800",minWidth:"100px",marginTop:"20px"}} onClick={saveForm}>Save</Button>
          </td></tr>
          </table>
        </center>
        </div>
